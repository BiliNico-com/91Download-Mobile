              ...
              child: Column(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    title: Text('防媒体扫描', style: TextStyle(fontSize: 14)),
                    subtitle: Text('在下载目录创建 .nomedia，防止视频出现在相册', style: TextStyle(fontSize: 12, color: Colors.grey)),
                    value: appState.nomediaEnabled,
                    onChanged: (v) => appState.toggleNomedia(v),
                  ),
                ],
              ),
            ),
